...
#define CUSTOM_MACHINE_NAME "Spike's (V1.1.6)"
...
#define DELTA
  ...
  #define DELTA_HEIGHT 285.59// get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 133.04 //mm  Get this value from auto calibrate
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 8000, 8000, 8000, 10000 }
...
//
//#define M100_FREE_MEMORY_WATCHER // uncomment to add the M100 Free Memory Watcher for  purpose
