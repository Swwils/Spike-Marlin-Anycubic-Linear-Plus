...
#define LIN_ADVANCE
   ...
   */
   #define LIN_ADVANCE_E_D_RATIO 0.0 // The calculated ratio (or 0) according to the formula W * H / ((D / 2) ^ 2 * PI)

  
  //#define LIN_ADVANCE_E_D_RATIO 0.01247255 // The calculated ratio (or 0) according to the formula W * H / ((D / 2) ^ 2 * PI)
                                  // Example: 0.4 * 0.2 / ((1.75 / 2) ^ 2 * PI) = 0.033260135
                                  // Example: 0.3 * 0.15 / ((1.75 / 2) ^ 2 * PI) = 0.01870883
                                  // Example: 0.3 * 0.10 / ((1.75 / 2) ^ 2 * PI) = 0.01247255
#endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_RETRACT_LENGTH 7         // Initial retract in mm
